...
Working as JavaScript Developer for Conntected Car Projects at 
[Valtech Mobility](https://github.com/ValtechMobility) from Dresden, Germany 🇩🇪
...
const tom = {
  ...
  languages: [ "JavaScript", "Java", "TypeScript", "Swift", "SQL", "C#", "PHP", "HTML", "CSS" ],
  frameworks: [ "React", "React Native", "Redux", "Apache OFBiz", "Storybook", "styled-components", "cypress" ],
  tools: [ "Git", "Docker", "Apache Kafka", "traefik", "nginx", "Jenkins", "Uptime Kuma" ],
  projectManagement: [ "GitHub", "Jira", "Confluence", "Bitbucket", "GitLab" ],
  architecture: ["microservices", "event-driven", "atomic design pattern"]
}
```
